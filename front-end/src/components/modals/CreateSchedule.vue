    ...
    <form action="" class="flex flex-col justify-around w-full h-full">
      <div>
        ...
        <div class="">
          ...
          <input class="border rounded p-2 w-full" type="datetime-local" name="date" id="date" required>
        </div>
        <div class="">
      ...
      <div class="flex justify-center">
        <button class="bg-purple-600 rounded-lg p-4 w-2/4 text-white hover:bg-purple-800 duration-200">Agendar mensagem</button>
      </div>
    </form>
  </div>
</template>